...
public class StaticPacketBuilder implements PacketBuilder {
    ...
    public StaticPacketBuilder addRShort(int i) {
		ensureCapacity(curLength + 2);
	 ...
	 * @param val The value.
	 * @return The StaticPacketBuilder instance, for chaining.
	 */
	public StaticPacketBuilder addTriByte(int val) {
		addByte ((byte) (val >> 16));
		addByte ((byte) (val >> 8));
		addByte ((byte) val);
		return this;
    ...
    public StaticPacketBuilder addBytes_Reverse_S(byte[] data, int len, int offset) {
